            ...
            <div class="table-responsive">
                <table class="table table-hover align-middle mb-0">
                    <thead class="table-light">
                        <tr>
                            <th width="70%" class="ps-4">動態文字廣告</th>
                            <th width="15%" class="text-center">顯示</th>
                            <th width="15%" class="text-center pe-4">刪除</th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php
